...
public class DataFrame {
	...
	DataFrameException list_invalid = new DataFrameException("Column " + label + " is invalid!");
	DataFrameException list_empty = new DataFrameException("Column " + label + " is empty!");
